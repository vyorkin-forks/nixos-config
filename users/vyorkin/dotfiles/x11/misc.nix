    ...
    home-manager.users.vyorkin = {
        ...
        home.file = {
            ...
            ".arbtt/categorize.cfg".text = ''
                ...
                -- projects at work
                current window ($program == "emacs" && $title =~ m!(?:~|home/vyorkin)/workspace/([a-zA-Z0-9]*)/src/.*-([a-zA-Z0-9]*)/!)
                  ==> tag project:$1-$2,
                current window ($program == "Alacritty" && $title =~ m!(?:~|home/vyorkin)/workspace/([a-zA-Z0-9]*)/src/.*-([a-zA-Z0-9]*)/!)
                  ==> tag project:$1-$2,

                -- personal projects
                current window ($program == "emacs" && $title =~ m!(?:~|home/vyorkin)/workspace/([a-zA-Z0-9]*)/([a-zA-Z0-9]*)/!)
                  ==> tag project:$1-$2,
                current window ($program == "emacs" && $title =~ m!(?:~|home/vyorkin)/.xmonad/!) ==> tag project:xmonad-config,
                current window ($program == "Alacritty" && $title =~ m!(?:~|home/vyorkin)/.xmonad/!) ==> tag project:xmonad-config,
                current window ($program == "emacs" && $title =~ m!(?:~|home/vyorkin)/.emacs.d/!) ==> tag project:emacs-config,
            ...
            ".config/screenshots/screenshots.yml".text = ''
                screenshots:
                  path: ${config.users.extraUsers.vyorkin.home}/screenshots
        ...
        programs.rofi = {
            ...
            theme = "${config.users.extraUsers.vyorkin.home}/.config/rofi/oxide.rasi";
