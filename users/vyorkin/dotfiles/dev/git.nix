...
let
    warningsOrgFile = "${config.users.extraUsers.vyorkin.home}/docs/org/tasks.org";
    gitSrcStopSnippets = [
        "ipdb"
        "wdb"
        "^\\s*print("
    ...
    home-manager.users.vyorkin = {
        home.file = {
            ...
            ".config/pass-git-helper/git-pass-mapping.ini".text = ''
                [github.com*]
                target=vyorkin/webservices/social/programming/github.com

                [bitbucket.org*]
                target=vyorkin/webservices/social/programming/bitbucket.com
            '';
        };
        programs.git = {
            enable = true;
            ...
            extraConfig = {
                ...
                "commit" = {
                    template = "${config.users.extraUsers.vyorkin.home}/git-assets/git-commit-template";
                };
                "rebase" = {
                    autoSquash = true;
                };
                "core" = {
                    autocrlf = false;
                    excludesfile = "${config.users.extraUsers.vyorkin.home}/git-assets/.gitignore";
                    quotepath = false;
                    askPass = "";
                    hooksPath = "${config.users.extraUsers.vyorkin.home}/git-assets/templates/hooks";
                };
                "credential" = {
                ...
                "init" = {
                    templatedir = "${config.users.extraUsers.vyorkin.home}/git-assets/templates";
                };
                "clone" = {
                    templatedir = "${config.users.extraUsers.vyorkin.home}/git-assets/templates";
                };
                ...
                "ghq" = {
                    root = "${config.users.extraUsers.vyorkin.home}/workspace/repos";
                };
                "ghq \"import\"" = {
